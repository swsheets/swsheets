defmodule EdgeBuilder.Changemap do
  ...
  def apply_changes(changesets, association_field, parent) when is_list(changesets),
    do: Enum.map(changesets, &apply_changes(&1, association_field, parent))
  ...
  defp add_relation(changeset, association_field, parent_model) do
    ...
    |> Ecto.Changeset.put_change(
      parent_model.__struct__.__schema__(:association, association_field).related_key,
      parent_model.id
    )
  end
end
